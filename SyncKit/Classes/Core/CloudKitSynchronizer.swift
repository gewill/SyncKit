...
public extension Notification.Name {
    ...
    static let SynchronizerWillSynchronize = Notification.Name("SKCloudKitSynchronizerWillSynchronizeNotification")
    /// Sent when the synchronizer is going to start the fetch stage, where it downloads any new changes from CloudKit.
    static let SynchronizerWillFetchChanges = Notification.Name("SKCloudKitSynchronizerWillFetchChangesNotification")
    /// Sent when the synchronizer is going to start the upload stage, where it sends changes to CloudKit.
    static let SynchronizerWillUploadChanges = Notification.Name("SKCloudKitSynchronizerWillUploadChangesNotification")
    /// Sent when the synchronizer finishes syncing.
    static let SynchronizerDidSynchronize = Notification.Name("SKCloudKitSynchronizerDidSynchronizeNotification")
    /// Sent when the synchronizer encounters an error while syncing.
    static let SynchronizerDidFailToSynchronize = Notification.Name("SKCloudKitSynchronizerDidFailToSynchronizeNotification")
}

// For Obj-C
@objc public extension NSNotification {
    /// Sent when the synchronizer is going to start a sync with CloudKit.
    static let CloudKitSynchronizerWillSynchronizeNotification: NSString = "SKCloudKitSynchronizerWillSynchronizeNotification"
    /// Sent when the synchronizer is going to start the fetch stage, where it downloads any new changes from CloudKit.
    static let CloudKitSynchronizerWillFetchChangesNotification: NSString = "SKCloudKitSynchronizerWillFetchChangesNotification"
    /// Sent when the synchronizer is going to start the upload stage, where it sends changes to CloudKit.
    static let CloudKitSynchronizerWillUploadChangesNotification: NSString = "SKCloudKitSynchronizerWillUploadChangesNotification"
    /// Sent when the synchronizer finishes syncing.
    static let CloudKitSynchronizerDidSynchronizeNotification: NSString = "SKCloudKitSynchronizerDidSynchronizeNotification"
    /// Sent when the synchronizer encounters an error while syncing.
    static let CloudKitSynchronizerDidFailToSynchronizeNotification: NSString = "SKCloudKitSynchronizerDidFailToSynchronizeNotification"
}
...
@objc public protocol AdapterProvider {
    ...
    /// - Parameters:
    ///   - synchronizer: `CloudKitSynchronizer` asking for the adapter.
    ...
    /// - Parameters:
    ///   - synchronizer: `CloudKitSynchronizer` that found the deleted record zone.
...
public class CloudKitSynchronizer: NSObject {
    ...
    */
    ...
    /// - Parameters:
    ///   - identifier: Identifier for the `CloudKitSynchronizer`.
