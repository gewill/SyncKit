...
- **`CloudKitDatabaseAdapter`**: A facade for `CKDatabase` to facilitate testing and provide async/await support.
...
- **Async Support**: Always provide both completion-handler and `async/await` versions for public asynchronous methods.
