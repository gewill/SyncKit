...
public extension Notification.Name {
    ...
    static let ModelAdapterHasChangesNotification = Notification.Name("SKModelAdapterHasChangesNotification")
}

@objc public extension NSNotification {
    
    /// /// Sent by the model adapter when it detects changes to some objects. The notification is sent only once, if there were no changes before and new changes were detected.
    static let ModelAdapterHasChangesNotification: NSString = "SKModelAdapterHasChangesNotification"
}
